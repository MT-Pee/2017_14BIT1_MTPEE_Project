CREATE DATABASE THANGTHANG CHARSET utf8 COLLATE utf8_unicode_ci;
USE THANGTHANG;
/*Table structure cho admin*/ 
CREATE TABLE IF NOT EXISTS `admin` (
    `id` int(20) NOT NULL AUTO_INCREMENT,
    `username` varchar(69)  CHARSET utf8 COLLATE uft8_unicode_ci NOT NULL UNIQUE,
    `password` varchar(69)  CHARSET utf8 COLLATE uft8_unicode_ci NOT NULL,
    `name` varchar(30) CHARSET utf8 COLLATE uft8_unicode_ci NOT NULL,
    PRIMARY KEY (`id`)
